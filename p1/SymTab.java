 ...
 * across nested scopes. Each scope is represented as a HashMap<String, Sym>, and 
 * the scopes are stored in a LinkedList<HashMap<String, Sym>>.
 * 
 * A LinkedList is used instead of an ArrayList because pushing and popping scopes 
